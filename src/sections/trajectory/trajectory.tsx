  ...
  return (
    <S.Trajectory id={id}>
      <S.TrajectoryContainer>
        ...
        <Paragraph $fontWeight='400' $balance={false} $size='lg' $textAlign='center' style={bodyParagraphStyle}>
        ...
        <S.TrajectoryExperienceContainer id='experiencias-section'>
          ...
          <Paragraph $balance={false} $size='2xl' $fontColor='#fff' $textAlign='left'>Atualmente possuo conhecimento avançado nas seguintes <S.TrajectoryHighlight>ferramentas</S.TrajectoryHighlight></Paragraph>
          <S.SkillsWrapper>
