...
export const experienceInfo: experienceinfoprops[] = [
  ...
  { id: 2, label: 'Websites e Landingpages', icon: '/IconWebsitesLandingpage.svg' },
  { id: 3, label: 'Sistemas WEB', icon: '/IconSystemWeb.svg' },
...
export const skillsInfo = [
  ...
  { id: 4, label: 'TypeScript', icon: '/typescript.png', color: '#3178C6' },
  { id: 5, label: 'React', icon: '/react.png', color: '#61DAFB' },
